    ...
    button.addEventListener('click', () => {
        ...
        projectCards.forEach(card => {
            if (filter === 'all-btn') {
                ...
                (filter === 'da-btn' && (card.textContent.includes('Crowd Funding') || card.textContent.includes('Sales Dashboard') || card.textContent.includes('Churn') || card.textContent.includes('Online Course'))) ||
